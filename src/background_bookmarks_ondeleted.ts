...
import { BookmarkProcess, BookmarkProccessDeleted } from './types/bookmark_process_type';

//ブックマークが削除されたら、実行される関数
export default async function backgroundBookmarksOnDeleted(id: string, removeInfo: chrome.bookmarks.BookmarkRemoveInfo) {
